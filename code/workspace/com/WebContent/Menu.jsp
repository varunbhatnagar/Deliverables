 ...
 *
 * @version 1.0
 *  This JSP is creating a MENU PAGE BEFORE LOGIN DYNAMICALY retreiving the data from database
 * 	
 * 
 **/%>
...
<!-- JavaScript -->
	...
	function clickhome(){
							...
							document.order.action="index.html";
        		...
        		<td height="42" >
					<span class="style2">
						<marquee behavior="alternate">
							<span class="style1"><a href="Login.html">LOGIN and Enjoy Unlimited Ordering</a></span>
						</marquee>
					</span>
        		</td>
      		</tr>
