 ...
 *
 * @version 1.0
 *  This JSP is generating data forOutlets at Mumbai
 * 	
 * 
 **/%>
...
<body bgcolor="#FFCC66">
<h3>OUTLETS IN MUMBAI<h3><br>
<%! Iterator locationItr;%>   <!-- Iterator to iterate through location list-->
   <%
   		Facade fc2=new Facade();
   		ArrayList locationlist=fc2.catchLocation("Mumbai");  //fetches all the outlets from Mumbai
